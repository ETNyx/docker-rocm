...
ENV ROCM_WHEEL_VERSION=7.2.4

ENV TRITON_VERSION=3.6.0
ENV TRITON_VERSION_DETAILS=git4ed88892-cp311-cp311
...
ENV TORCH_VERSION_DETAILS=lw.git3d3aa833-cp311-cp311
